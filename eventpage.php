										...
										<div class="slide_description_wrapper">
											<div class="slide_description">
												<div class="intro-layer" data-animation="fadeInRight">
													<h2 style="font-weight: 700;font-style: normal;font-family: 'Lato', sans-serif;color: #ffffff;font-size: 60px;line-height: 1.1;letter-spacing: 0px;">Event
...
<section>
    <div class="rows " style="background-color: white;">
        ...
        ?>
        <div class="gallery">
            <a href=""><img src="<?php echo "../events/".$row['name'];?>"></a>
        </div>
